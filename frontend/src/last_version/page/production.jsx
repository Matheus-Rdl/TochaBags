      ...
      <div className="flex flex-col gap-10">
        ...
        <div>
          ...
          <div className="flex gap-5 justify-center">
            <div>
              <img src="p1.png" className="max-w-40 w-[100%] min-w-[75px]" />
              <p className="text-center">Bordados</p>
            </div>

            <div>
              <img src="p2.png" className="max-w-40 w-[100%] min-w-[75px]"  />
              <p className="text-center">Padrões ou desenhos</p>
            </div>

            <div>
              <img src="p3.png" className="max-w-40 w-[100%] min-w-[75px]"  />
              <p className="text-center">Rodinhas</p>
            </div>

            <div>
              <img className="rounded-full max-w-40 w-[100%] min-w-[75px]" src="p4.png" />
