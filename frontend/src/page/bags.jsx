export default function Bags() {
  return (
    <section className="section-bags">
      ...
      <div className="flex flex-col gap-30 my-15">
        <div>
          <div className="relative mr-[30%]">
            <img className="w-[60%] [clip-path:polygon(0_0,90%_0,100%_100%,0_100%)]" src="percussion-img.png" />
        ...
        <div>
          <div className="relative ml-[30%]">
            <img className="w-[60%] [clip-path:polygon(10%_0,100%_0,100%_100%,0_100%)] ml-[40%]" src="strings-img.png" />
        ...
        <div>
          <div className="relative mx-[12%]">
            <img className="w-[60%] [clip-path:polygon(10%_0,90%_0,100%_100%,0_100%)] mx-[20%]" src="percussion-img.png" />
        ...
        <div>
          <div className="relative mr-[30%]">
            <img className="w-[60%] [clip-path:polygon(0_0,100%_0,90%_100%,0_100%)]" src="strings-img.png" />
