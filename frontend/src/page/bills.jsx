  ...
  return (
    <section className="section">
      ...
      <div className="flex ">
        ...
        <div className="-mx-1 w-full bg-amber-400/50 [clip-path:polygon(0_0,92.5%_0,100%_100%,7.5%_100%)]">
        ...
        <div className="-mx-1 w-full bg-green-700/50 [clip-path:polygon(0_0,92.5%_0,100%_100%,7.5%_100%)]">
        ...
        <div className="-mx-1 w-full bg-(--color-brown)/50 [clip-path:polygon(0_0,92.5%_0,100%_100%,7.5%_100%)]">
